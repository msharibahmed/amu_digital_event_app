        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 5.0, top: 2, bottom: 1.5),
                child: Text(
                  DateFormat('dd MMM').format(prov[index].startDate) +
                      '-' +
                      DateFormat('dd MMM').format(prov[index].endDate),
              ...
              Padding(
                ...
                child: Text(
                    'Time: ' +
                        DateFormat('hh:mm aaa').format(prov[index].startDate) +
                        '-' +
                        DateFormat('hh:mm aaa').format(prov[index].endDate),
                    style: const TextStyle(
                        fontSize: 14,
              ...
              Padding(
                ...
                child: Text(
                    'Mode: ' + (prov[index].online ? 'Online' : 'Offline'),
                    style: const TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w200,
                        color: Colors.grey)),
